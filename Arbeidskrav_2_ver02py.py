...
Sist oppdatert 2025 - 11 - 9

"""

# Oppgave 1 - Hvor gammel ble en person i 2024?

alder = int(input("Hvilket år er du født? "))
print("I 2024 vil du være", 2024-alder)


# Oppgave 2 - Antall pizza per elev.

antall_elever = int(input("Skriv inn antall elever:" ))
print("Ved", antall_elever, " elever, vil man trenge man", int(antall_elever * 1/4), "pizzaer")


# Oppgave 3 - Regner grader til radianer.
...
# Oppgave 4 - Dictionary over ulike land + legge til nytt land 
...
# Oppgave 5 - Regne ut areal + ytre omkrets av figur med funksjon. 
...
print(f"Areal av figur er {areal:.2f}")
print(f"Omkrets av figur er {omkrets:.2f}")



#Oppgave 6 - Plotte funksjon. 
